<template>
  <div class="container">
    ...
    <div class="listSort">
      ...
      <button v-on:click="testmin">test min max</button>
    </div>

    <div class="liste">
      <select @change="testmin($event)">
        <option disabled value="">Choisissez</option>
        <option value="score">Score</option>
        <option value="calculComments">comment Score</option>
        <option value="calculLike">like score</option>
        <option value="calculreach">reach Score</option>
        <option value="calculImpression">impressions score</option>
        <option value="calculSaved">Saved Score</option>
        <option value="calculOccurence">Occurence Score</option>
      </select>
    </div>

    <div class="liste">
      <select @change="sortScore($event)">
        <option disabled value="">Choisissez</option>
        <option value="score">Score</option>
        <option value="calculComments">comment Score</option>
        <option value="calculLike">like score</option>
      ...
      <ul v-for="(doc, index) in sortedData">
        <div class="card">
          ...
          <div class="weighted">
            ...
            <div>{{ doc.ponderationOccurence }}</div>
          </div>
          <div class="lastPost">
...
export default {
      ...
      NUData: [
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "The wireless charger has trouble with an iPhone 12 Pro Max \u0040nativeunion",
                id: "18220062190006710",
              },
              {
                timestamp: "2021-04-16T17:43:45+0000",
                text:
                  "I \u2764\ufe0f\u2764\ufe0f\u2764\ufe0f my drop wireless classic leather in black & my brother his cognac one!!",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/173506067_466107564604112_4096150845674518478_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=7zlrP8zI7JgAX_k4fQJ&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=255dde50be3f20548f405141ec106553&oe=60A1CB84",
          media_type: "IMAGE",
            ...
            data: [
              {
                ...
                title: "Couverture",
                description:
                  "Nombre total de comptes uniques ayant vu le m\u00e9dia",
              ...
              },
              {
                ...
                title: "Impressions",
                description:
                  "Nombre total de fois o\u00f9 le m\u00e9dia a \u00e9t\u00e9 vu",
              ...
              },
              {
                ...
                title: "Enregistr\u00e9",
                description:
                  "Nombre total de comptes uniques ayant enregistr\u00e9 le m\u00e9dia",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/173026007_298455628336617_2381612101701624174_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=RuHZ7TJhHCoAX8Zht0Z&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=f63a8bf84a7134596a4d62f8160d2363&oe=60A33A65",
          media_type: "IMAGE",
        ...
        },
        {
            ...
            data: [
              {
                ...
                text:
                  "Are you bringing this back? Says sold out on the website \ud83d\ude22",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/170523280_301423804712207_4969705066072581712_n.jpg?_nc_cat=103&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=PDOz4q4GmPwAX8UoIUL&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=deb7cfcd5ccd473653149b3fae85fa0c&oe=60A15E2F",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "\ud83d\ude0d\ud83d\ude0d\ud83d\ude0d these are my favorites things including cognac version!!! Hope my next item will be belt cable c to c in cosmos. My belt cable pro c to c in cosmos is lonely \ud83d\ude02",
                id: "17877294872210009",
              },
              {
                timestamp: "2021-04-07T14:01:13+0000",
                text:
                  "#wirelesscharger #wirelesscharging #honestreview #mytoppicks #productdesign #leathergoods #leatherwirelesscharger #elevated #minimalist #minimalistdesign #minimalistliving #minimalistinterior #iphonecharger #airpodscharger #livesmarter #smartliving #dapperlife #gentlemenaccessories #gentlemencode #dapperlifestyle #nativeunion #techrefined  #dropwireless #interiorsetup #interiorinspo",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/169393613_119666783528045_491572055309766901_n.jpg?_nc_cat=108&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=F6h33f5RJdgAX_pOAkw&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=00aa114feeab17a7c879b275cbdf32fd&oe=60A2DAC0",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/168540191_352139339540868_7167453728423855802_n.jpg?_nc_cat=106&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=1ZdMg782VvYAX9GCgJu&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=53acd2e4d9ac13990795cc70049627d9&oe=60A4A0BB",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "Looks like a card holder wallet! You guys should definitely make one like that",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/168857321_3047646268891835_5363915275681558673_n.jpg?_nc_cat=108&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=Iw1rfdSAAPgAX_gPu2S&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=9063da3a794a948dff96cacc52a60ef2&oe=60A23B51",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#productdesign #luxdesign #airpodscase #airpodsprocase #leathercase #leathergoods #nativeunion #techrefined  #everydaycarry #whatsinmybag #airpodcase #airpodprocase #handcrafted #honestreview #minimaliststyle #backtobasics #presentsforhim #presentsforher #fashioninspo #playmymusic #musicislife",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/166184402_436115730950507_6169932514784353813_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=iPkqrj7HgCAAX86wHvf&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=1e676a9503bee12fb6ff156958fc69f6&oe=60A2052D",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/165110273_467628294577510_4610582434318472144_n.jpg?_nc_cat=104&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=p5FnBe9P-jMAX9F2-93&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=b25a0017e7e2e6046deed1e948da18d9&oe=60A105BF",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/163599868_836232367102419_841641238104542620_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=My9c5HOm_IsAX_kje00&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=ad2e35b8f729c3f8f14c7cb78c1606f4&oe=60A3E0DE",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/162720489_912597742861093_2225038973466767957_n.jpg?_nc_cat=103&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=V3E6fhv4LbQAX8ZDIqH&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=994eaf3d69dde908cabf04e983fce4de&oe=60A483DA",
          media_type: "IMAGE",
        ...
        },
        {
            ...
            data: [
              {
                ...
                text:
                  "Will you be making MagSafe versions of your cases? I know we can still technically charge with MagSafe, but the magnetic feature is too weak and can\u2019t use it on MagSafe stands/ upright chargers (e.g. Belkin MagSafe dock)",
                id: "18166395661189443",
              },
              {
                timestamp: "2021-03-28T05:29:09+0000",
                text:
                  "Love this so much \ud83d\ude0d my fav colour \u2764\ufe0f",
                id: "17862383192435369",
              },
              {
                timestamp: "2021-03-21T15:51:18+0000",
                text:
                  "I just bought mine a few weeks ago and now I wish I had waited :/",
              ...
              },
              {
                ...
                text:
                  "got a Clic Canvas... am I going to buy another one for MagSafe? bro obvious answer.",
                id: "17889803861013409",
              },
              {
                timestamp: "2021-03-19T14:35:48+0000",
                text:
                  "Yaaaaaaas can\u2019t wait! I\u2019ve wanted to get this case but wished it had MagSafe. \ud83d\ude4c",
                id: "17902559161818008",
              },
              {
                timestamp: "2021-03-19T14:35:45+0000",
                text:
                  "That would be dope if the leather cases can get a MagSafe upgrade",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/161744387_2919443211670349_3329206387316465754_n.jpg?_nc_cat=103&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=hXm4kHPoGfgAX-a3DKq&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=93274978d6ae364dfb904e957bb1c9d4&oe=60A3317A",
          media_type: "IMAGE",
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "Really want the wireless charger \ud83d\ude0d \u0040screviewsbeauty",
                id: "17886844619091257",
              },
              {
                timestamp: "2021-03-23T15:43:45+0000",
                text:
                  "Really want the wireless charger \ud83d\ude0d \u0040pearlieee__",
            ...
            paging: {
              cursors: {
                after:
                  "UVZAGRFdUZAzFVVlZARTkRSdWVGcGpMWEZAwV0dWMFpuWTFRVWswVWtabWNYZAGlRbnAxZAFUxTVZAsRkZAZAbVZANWDJ4VlpVSlJjSFoxV25ScGMwMUtjRnBvY0hab1pWWnpiVnAxVFUweWVrWndaVmd5WkRSQ2JHTTNaZAz09",
              },
              next:
                "https://graph.facebook.com/v10.0/17870706434300483/comments?access_token=EAAD4764ZBe5oBAJHVfDiBt529WWIYRuLCvN2c1ZCpZCq5k1nz5F1mImymmWNr57ZAf7Ru8JZAGZAZAMjehBjnP4aZAxGCr9BdrZBlpZAwhmr8B8csCTQOaZCgpP1ZBBQDPsZAfbuNZAx3PZBMKzUaTcZCXJ48jgZAeQcZAsLZC9397mRMFmrZAQHT4GhQpz1MY59&limit=25&after=UVZAGRFdUZAzFVVlZARTkRSdWVGcGpMWEZAwV0dWMFpuWTFRVWswVWtabWNYZAGlRbnAxZAFUxTVZAsRkZAZAbVZANWDJ4VlpVSlJjSFoxV25ScGMwMUtjRnBvY0hab1pWWnpiVnAxVFUweWVrWndaVmd5WkRSQ2JHTTNaZAz09",
            },
          },
          timestamp: "2021-03-16T17:00:53+0000",
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.29350-15/161718013_1642251435977804_367282989269833317_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=vhN9HKKfYnYAX_aoxJq&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=d248c792e6dea039209ea33dca19e954&oe=60A3E39A",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#everydaystyle #roamanywhere #airpodscase #airpodsprocase #airpodsprocasewithclip #airpodscasewithclip #onthegoessential #musicanywhere #playmymusic #nativeunion #techrefined #outdooraccessories #travelessentials #whatsinmybag #edc #everydaycarry #applefan #applecase #onthegomusthave #travelmusthave #travelfavorite",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/160600521_147689717227327_3363717598160574108_n.jpg?_nc_cat=108&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=jbX0nCmmgXUAX9GdHyn&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=cd40f3a1b575fb95255b1fea447f5032&oe=60A28205",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "How about a Stow Slim Sleeve for 12.9 iPad Pro in different colors?\nLike indigo... \u2639\ufe0f grey ist boring \ud83e\udd37\ud83c\udffb\u200d\u2642\ufe0f",
                id: "17900374813829115",
              },
              {
                timestamp: "2021-03-12T16:00:42+0000",
                text:
                  "#usbc #typeccable #newcolor #appleaccessories #chargefaster #techaccessories #edc #everydayroutine #lifehack #lifetip #nativeunion #workfaster #workhardanywhere #homepod #homepodmini #ipad #ipadaccessories #iphoneaccessories #appleaddict #newcolors #newrelease #strongconnection #techupdate #newtech",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/158979886_1007125693027048_4594271538307537031_n.jpg?_nc_cat=106&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=sCuGPrk6-EgAX8qVeCL&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=c04f2cc88f48d1737fecfedd5930c230&oe=60A15EDA",
          media_type: "IMAGE",
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#pov #lifesolutions #lifehacks #simplesolutions #makelifeeasier #nativeunion #techrefined #cable #nightstandessentials #tableaccessories #whatsonmytable #tableinspo #minimalistdesign #minimalistinterior #organizedliving #sparkjoy #applefan #appleaddict #pastelaccessories #lifehack #organizationsolution #propdesign",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/157495922_1386779691655703_2702887543186475803_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=l5y4o6WwP2YAX8j2aBF&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=afdd203be643e18fa0536b7cd8656c4e&oe=60A3A51B",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/156151180_478707803285010_1885213526888491016_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=bZ6qkh4q8K4AX-rv4un&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=1ac3d8a0ef26adec363932a17e3c6ccc&oe=60A34A1E",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#ugc #usergeneratedcontent #techlifestyle #teamapple #applefan #airpodmax #whatsinmybag #whatsonmytable #tablelayout #flatlay #flatlayinspo #applelifestyle #appleandcoffee #myedc #techwear #nativeunion #techrefined #blackflatlay #techflatlay #flatlayinspo #moderntech",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/156586671_262806885452189_8208991070787224093_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=P53QFbjO5tcAX983iLn&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=60b7c73fbfa8737c9b9fb0e1ff66747c&oe=60A1E7B0",
          media_type: "IMAGE",
        ...
        },
        {
            ...
            data: [
              {
                ...
                text:
                  "Will the c to c belt cable in stock but in variant colours like cosmos, rose & indigo??",
                id: "17920172659595578",
              },
              {
                timestamp: "2021-02-28T21:19:00+0000",
                text:
                  "Any thoughts on making a card holder in the same style as the Clic cases? Love the look of the Heritage Card Holder but don\u2019t think it\u2019s for me.",
                id: "18193770280065329",
              },
              {
                timestamp: "2021-02-27T15:01:08+0000",
                text:
                  "#reviews #honestreviews #productreview #productdesign #bestcable #ipadaccessories #macbookaccessories #appleaccessories #whatsonmytable #everydayessentials #techlifestyle #techaccessories #nativeunion #workhardanywhere #techrefined #powerallday #everydaycarry #practicalgifts #lifehack #everydayhack #techhack",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/154783587_198177855389917_1024289010836668389_n.jpg?_nc_cat=106&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=LN6g0obDB1sAX8ky55V&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=1b3b00557bd04ce17e8c194666a94721&oe=60A263B5",
          media_type: "IMAGE",
        ...
        },
        {
            ...
            data: [
              {
                ...
                text:
                  "I have the old charger without led light. It has been working excellently for 2 years. But now the cable is getting damaged \ud83d\ude22. Still better than apple cable that lasts only few months.",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/153543418_206821007849033_5460008925118272416_n.jpg?_nc_cat=104&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=iO8jJjvHLsMAX-s-1sw&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=a2e62f88d920723ead9cc66be0b071a1&oe=60A3AD42",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/154060215_878830482905347_3059330586439640981_n.jpg?_nc_cat=108&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=Xpmamtm4wdQAX-m3gjK&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=da15f287cecce85e321f00906cb0cf3f&oe=60A1F2A3",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/152091766_459391931856331_13497267052693519_n.jpg?_nc_cat=109&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=YC3iRcDpZP4AX9BJUNb&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=31018943e11a76c9e8bbd3079a3703d9&oe=60A48ACA",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#ChillaxFox #MaisonKitsune #MaisonKitsunexNativeUnion #collaboration #dynamicduo #everydaycarry #airpodsprocases #collab #appleandcoffee #cutecases #whatsinmybag #everydayinspo #streetlifestyle #streetstyle #signupforfree #nativeunion #techrefined #tablesetup #flatlay #flatlayinspo #hypestyle #hypelifestyle #playmymusic",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/151001569_516962099268109_3235669125826930951_n.jpg?_nc_cat=109&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=aw9kOivbRh4AX_qQyuL&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=5bcb1811bd7add65adfc289dcd055305&oe=60A27055",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "Curious to know why these ones cover the bottom and the newer iPhone 12 native union covers don\u2019t? Best cover I\u2019ve ever had when I had the XS but pity didn\u2019t follow up for the newer ones. Surely design team know already after a few months of feedback.",
              ...
              },
              {
                ...
                text:
                  "\u0040nativeunion are you going to carry this model in a black color way?",
              ...
              },
              {
                ...
                text:
                  "just received it, that\u2019s really nice \ud83e\udd8a\ud83e\udd0d",
                id: "18179873149072839",
              },
              {
                timestamp: "2021-02-16T15:49:49+0000",
                text:
                  "Do you have silicone case for iphone 12 pro max that covers the bottom part and no Maison Kitsune print at the back?",
          ...
          media_url:
            "https://scontent-cdt1-1.cdninstagram.com/v/t51.2885-15/150217601_778931399382986_5252287126338377059_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=AfuQdVZSZNEAX_LBChI&_nc_ht=scontent-cdt1-1.cdninstagram.com&oh=e94b8d6b638b07634664125a27230dd5&oe=60A1AE33",
          media_type: "IMAGE",
        ...
        },
        {
          ...
          comments: {
            data: [
              ...
              },
              {
                ...
                text:
                  "#nightcable #youandi #giftsforher #giftsforhim #giftsforthem #giftsforus #giftstomatch #valentinesdaygift #vdaygift #giftguide #giftideas #practicalgift #giftsforeveryday #giftshelllove #nativeunion #techrefined #couplegoals #couplestyle #tellmewithouttellingme #loveisinthedetails #loveisinthedetail #homeinspo #interiorinspo #roominspo #tableinspo #tablesetup #nightcable #giftsforanyone #giftsforeveryone",
          ...
          media_url:
            "https://scontent-cdg2-1.cdninstagram.com/v/t51.2885-15/148558023_478021436917630_6937859360827404805_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=8ae9d6&_nc_ohc=L7UyK5AFChUAX8Jh1Qv&_nc_ht=scontent-cdg2-1.cdninstagram.com&oh=fcbedda8452b3dd5b7bb84e095990e98&oe=60A411B4",
          media_type: "IMAGE",
  ...
  methods: {
    ...
    async computedData() {
      ...
      for (let x = 0; x < this.NUData.length; x++) {
        ...
        if (this.NUData[x].comments) {
          var tempHash = [];
          tempHash = await this.NUData[x].comments.data[
            this.NUData[x].comments.data.length - 1
          ].text
            .split("#")
            .filter(Boolean);
                ...
                posts: [
                  {
                    ...
                    permalink: this.NUData[x].permalink,
                    reach: this.NUData[x].insights.data[0].values[0].value,
                    impressions: this.NUData[x].insights.data[1].values[0]
                      .value,
                    saved: this.NUData[x].insights.data[2].values[0].value,
                  },
                ],
    ...
    async sortScore(event) {
      console.log(event.target.value);
      var sorter = event.target.value;
      var bySelect = await this.sortedData.slice(0);
      await bySelect.sort(function (a, b) {
        return b[sorter] - a[sorter];
      });
      console.log("by Saved:");
      console.log(bySelect);
      console.log(this.hashcomputed);
      this.sortedData = await [];
      this.sortedData = await bySelect;
    },

    testmin(event) {
      
      var min = this.sortedData.reduce(
        (min, p) => (p.[event.target.value] < min ? p.[event.target.value] : min),
        this.sortedData[0].[event.target.value]
      );
      var max = this.sortedData.reduce(
        (max, p) => (p.[event.target.value] > max ? p.[event.target.value] : max),
        this.sortedData[0].[event.target.value]
      );

      for (var x = 0; x < this.sortedData.length; x++) {
        var percent = ((this.sortedData[x].[event.target.value] - min) / (max - min)) * 100;
        this.sortedData[x].[event.target.value] = percent;
      }
    ...
    score() {
      ...
      for (var x = 0; x < this.sortedData.length; x++) {
        ...
        this.sortedData[x].calculOccurence = calculOccurence;
        ...
        this.sortedData[x].ponderationOccurence = ponderationOccurence;
      }
      ...
      for (var a = 0; a < this.sortedData.length; a++) {
        for (var y = 0; y < att.length; y++) {
          var min = this.sortedData.reduce(
            (min, p) => (p.[att[y]] < min ? p.[att[y]] : min),
            this.sortedData[0].[att[y]]
          );
          var max = this.sortedData.reduce(
            (max, p) => (p.[att[y]] > max ? p.[att[y]] : max),
            this.sortedData[0].[att[y]]
          );
          var percent = ((this.sortedData[a].score - min) / (max - min));
          this.sortedData[a].[att[y]] = percent;
        }
      }
    },
  },
